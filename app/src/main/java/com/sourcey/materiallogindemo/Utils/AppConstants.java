...
public class AppConstants {
  ...
  /*  public static final String DB_NAME="SAMPLE";
    ...
    public static final String STD_TABLE="Student";*/
 ...
 /*public static final String STD_ALREADY_EXIST_QUERY="select * from "+STD_TABLE+" where "+LOC_LONGITUDE+LOC_LATTTUDE+LOC_TIME+LOC_ID+"=";
*/
}
